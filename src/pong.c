#include <stdio.h>
// printf ("\033[0d\033[2J");; //очистка консили
...
char read_char(void) {
    char ch = getchar();  // Чтение одного символа
    getchar();            // Для считывания нажатия Enter
...
void draw(int p1_y, int p2_y, int ball_x, int ball_y, int score_player1, int score_player2) {
    ...
    for (int y = 0; y < HEIGHT; y++) {
        if (y == 0)
            printf("\n");  // нужно для отображения номера нулевой строки в правильном
                           // месте
        // printf("%02d", y);          // сделал отображение номеров строк из 2
        // символов
